...
with app.app_context():
    ...
    user = [
        ...
        {'username': 'David Oloye', 'email': 'ooloye04@umd.edu', 'first_name': 'David', 'last_name': 'Oloye',
    ...
    students = [
        ...
        {'student_id': '1', 'first_name': 'David', 'last_name': 'Oloye', 'email': 'ooloye04@umd.edu',
         'major_id': 3, 'birth_date': dt.datetime(2004, 6, 2), 'is_honors': 1}
    ]
